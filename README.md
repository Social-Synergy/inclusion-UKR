...
For free download please use files from repository above (file types: .ttf, .otf, .woff, .woff2, [.eot](https://github.com/Social-Synergy/inclusion-UKR/blob/master/inclusion.ukr.eot)).
